...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "PK3ZVSsIeDLmc9qIUg4tWJb4hopZGE09XuyllMtd";
    private static final String SECRETKEY = "z-8AkXx204PW_zw8Xrs2BZKgJ5xRjqdX3LJFNI-p";
    private static final String BUCKET = "zmc";
    public static final String DOMAIN= "http://qx6oa8au9.hn-bkt.clouddn.com/";


    public static void main(String[] args) {
       // uploadFile("C:\\Users\\zmc\\Desktop\\杂\\logo_new.png","logo_new1.png");
